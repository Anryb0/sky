      ...
      <main>
        ...
        >
		  ...
		  <h2>Виртуализация</h2>
			...
			<br />
			<div id='p4'>
			<img alt='схема' title='схема' src="/sky/c4.png" className='articleimg'/>
			<div>
			<h3><b>Виртуализация отделяет вычислительные ресурсы от оборудования и позволяет создавать множество виртуальных сред на одной физической IT-инфраструктуре.</b></h3><p> Пользователь арендует <b>виртуальный сервер (VPS/VDS)</b> — это изолированный виртуальный аналог физического сервера с заданными лимитами ресурсов.
